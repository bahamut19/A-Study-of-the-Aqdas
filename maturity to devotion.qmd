...
The Kitáb-i-Aqdas mentions maturity twice. The first is when prayer and fasting become obligatory[^maturity-to-devotion-2] and the second is when one becomes eligible to receive inheritance.[^maturity-to-devotion-3] On the latter right, Bahá’u’lláh conditions trusteeship if the descendant is weak instead of being mature. What might weakness be related to?
...
## The Badí‘ Calendar's Rhythm of Maturity
